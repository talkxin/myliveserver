...
body {
	...
	padding: 0;
	color: #000;
	background: url(images/login_bd.jpg) repeat-x;
}
...
<script type="text/javascript">
	function btnDown() {
		document.getElementById("sub").style.backgroundImage = "url(images/logind.png)";
	}
	function btnOut() {
		document.getElementById("sub").style.backgroundImage = "url(images/loginup.png)";
	}
			...
			<div class="content">
				...
				<div class="i3">
					邮&nbsp;&nbsp;&nbsp;箱: <INPUT type="text" name="userModel.email"
						id="mailAdress" value=""> <input type="button"
				...
				<div class="i4">
					验证码: <input type="text" id="verifycode" name="verifycode"
						maxlength="6"> <img src="securityCodeImageAction.do"
						id="Verify" style="cursor: pointer;" alt="看不清，换一张" /> <br /> <input
						type="button" name="sub" id="sub" value=""
						style="background-image: url(images/loginup.png); height: 28px; width: 106px; cursor: pointer;"

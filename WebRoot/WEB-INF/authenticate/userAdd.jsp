    ...
    <div class="mainbox">
      <form id="form1" name="form1" action="insertUser.do" method="post" >
	      ...
	      <ul class="memlist fixwidth">
	        <li><em>用户姓名<span class="red">*</span>：</em>
	        ...
	        <li><em>登录名称<span class="red">*</span>：</em>
	        ...
	        <li><em>登录密码<span class="red">*</span>：</em>
	        ...
	        <li><em>用户邮箱<span class="red">*</span>：</em>
	        ...
	        <li><em>所属角色<span class="red">*</span>：</em>
	        	<select name="userModel.roleId">

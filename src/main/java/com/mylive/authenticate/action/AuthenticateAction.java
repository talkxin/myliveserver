package com.mylive.authenticate.action;
...
import com.mylive.authenticate.interceptor.SecurityCode;
import com.mylive.authenticate.interceptor.SecurityImage;
import com.mylive.authenticate.model.MenuModel;
...
public class AuthenticateAction extends BaseAction implements SessionAware {
	...
	public String check() {
		try {
			...
			String code = (String) this.session.get("securityCode");
...
//		emailModel.setFrom("bjdata@c-platform.com");// 设置发送人
//		emailModel.setTo(getTo().trim());// 设置接收人
//		emailModel.setTitle("海南换机平台系统");// 设置标题
//		// 取随机产生的认证码(4位数字)
//		String sRand = "";
